...
var UsersList = function (_Component) {
  ...
  _createClass(UsersList, [{
    ...
    value: function renderUsers() {
      var list = this.props.user.map(function (user) {
        return _react2.default.createElement(
          "li",
          { key: user.id },
          user.name
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        this.props.user.length && _react2.default.createElement(
          "ul",
          null,
          this.renderUsers()
        ) || _react2.default.createElement(
...
exports.default = {
  component: (0, _reactRedux.connect)(mapStateToProps)(UsersList),
  loadData: loadData
};
